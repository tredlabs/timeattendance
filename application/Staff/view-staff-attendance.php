 ...
 * */
//<!--$testDaysPassed--><!--PUT THIS BACK<!--$daysPassedForEach--><!--$noDays-->-- >   $staffAPercentage   $fullAttendancePercentage $staffStatus
$viewIcon= "<button class='btn btn-success' onclick=window.location='view-staff-attendance-details.php?id=$staffID'><i class='fa fa-eye'></i></button>";
			echo"
			<tr>
