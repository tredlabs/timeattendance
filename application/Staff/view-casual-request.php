        ...
        <div class="wrapper">
			...
			<div class="row">
                    <div class="col-sm-12">
						...
						<button class="btn btn-success" style="margin-bottom:15px" onclick="window.location='request-casual.php'"> Request Casual days </button>
...
WHERE requests.request_type='2' && users.id='$userID'
