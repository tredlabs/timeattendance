        ...
        <div class="wrapper">
			...
			<div class="row">
                    <div class="col-sm-12">
						...
						<button class="btn btn-success" style="margin-bottom:15px" onclick="window.location='request-special.php'"> Request Special days </button>
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php
$query= "SELECT requests.request_id AS requestID, SUM(value) AS countRequests,requests.*, users.* 
FROM requests
...
WHERE requests.request_type='4' && users.id='$userID'
...
if($sApproved==="0")
{
	$statusIcon="<button class='btn btn-danger' onclick=window.location='php-update-casual-status.php?ns=1&lid=$requestID'><i class='fa fa-times'></i></button>";
}
if($sApproved==="1")
{
	$statusIcon="<button class='btn btn-primary' onclick=window.location='php-update-casual-status.php?ns=0&lid=$requestID'><i class='fa fa-check'></i></button>";
}


$viewIcon= "<button class='btn btn-success' onclick=window.location='view-casual-days-details.php?id=$requestID'><i class='fa fa-eye'></i></button>";
