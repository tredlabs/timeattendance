...
$balanceDays= $userCasual-$countNoRequest;

if($checkDate>$balanceDays)
{
	header("location:request_error.php?error=6");
}
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card-box">
						  ...
						  <form name="" action="php-add-casual-request.php" method="post" enctype="multipart/form-data">
						...
						<div class='col-md-8'>
						 <input type='date' class='form-control' name='casualDate[]' />
						 </div>
						 <div class='col-md-2'>
