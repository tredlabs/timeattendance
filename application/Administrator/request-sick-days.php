...
if($countNoRequest>$userSick)
{
	header("location:request_error.php?error=2");
} */
?>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card-box">
							...
							<?php echo $error1?>
						  <form name="" action="sick-days-III.php" method="post" autocomplete="off">
						 <div class="row">
						 
						 
						 <select name="staffMember" class="form-control" required>
