			...
			<div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
							...
							<button class="btn btn-success" onclick="window.location='add-users.php'"> Add user </button>
							<hr/>
                                <thead>
                                    <tr>
                                         <tr>
								...
								if($conn)
{
	if ($result = mysqli_query($conn, "SELECT users.id AS Cid, users.*,user_types.*
	FROM users
...
$staffID= $info['id'];
$staffID1= base64_encode($info['Cid']);
$staffID2= $info['Cid'];
$staffUserName= $info['username'];
$staffType= ucwords($info['type']);





$editIcon= "<button class='btn btn-warning' onclick=window.location='edit-users.php?cid=$staffID1'><i class='fa fa-pencil'></i></button>";

$deleteIcon= "<button class='btn btn-danger' onclick=window.location='php-delete-account.php?cid=$staffID'><i class='fa fa-trash'></i></button>";

$resetIcon= "<button class='btn btn-primary' onclick=window.location='php-reset-account.php?cid=$staffID1'><i class='fa fa-retweet'></i></button>";

$enrollIcon= "<button class='btn btn-success' onclick=window.location='php-reset-enroll.php?cid=$staffID1'><i class='fa fa-refresh'></i></button>";
