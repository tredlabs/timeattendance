                    ...
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php
$query= "SELECT users.id AS cUID, requests.request_id AS requestID, COUNT(DISTINCT date) AS countRequests,requests.*, users.* 
FROM requests
...
if($sApproved==="0")
{
	$statusIcon="<button class='btn btn-danger' onclick=window.location='php-update-vacation-status.php?ns=1&lid=$requestID&u=$cUID'><i class='fa fa-times'></i></button>";
}
if($sApproved==="1")
{
