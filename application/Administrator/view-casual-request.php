...
if($sApproved==="0")
{
	$statusIcon="<button class='btn btn-danger' onclick=window.location='php-update-casual-status.php?ns=1&lid=$requestID&u=$cUID'><i class='fa fa-times'></i></button>";
}
if($sApproved==="1")
{
