...
$staffFirstName1= base64_encode($info['firstName']);
$staffLastName1= base64_encode($info['lastName']);
$staffID1= base64_encode($info['id']);


$generateIcon= "<button class='btn btn-success' onclick=window.open('report-departmental-sick-leave-II.php?id=$staffID1&fn=$staffFirstName1&ln=$staffLastName1')><i class='fa fa-send-o'></i></button>";
			echo"
			<tr>
