			...
			<div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
							...
							<!--<button class="btn btn-success" onclick="window.location='request-sick-days.php'"> Add Request </button>-->
							<hr/>
                                <thead>
                                    <tr>
                                         <tr>
                                ...
                                <tbody>
                                    <?php
$query= "SELECT users.id AS cUID, requests.staff_id AS nStaffID, requests.request_id AS requestID, SUM(value) AS countRequests,requests.*, sick_reason.*, users.* 
FROM requests
...
if($sApproved==="0")
{
	$statusIcon="<button class='btn btn-danger' onclick=window.location='php-update-sick-status.php?ns=1&sid=$requestID&u=$cUID'><i class='fa fa-times'></i></button>";
}
if($sApproved==="1")
{
...
$viewIcon= "<button class='btn btn-success' onclick=window.location='view-sick-days-details.php?id=$requestID&SID=$nStaffID'><i class='fa fa-eye'></i></button>";
