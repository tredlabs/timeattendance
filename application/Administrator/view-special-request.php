                    ...
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php
$query= "SELECT users.id AS cUID, requests.request_id AS requestID, SUM(value) AS countRequests,requests.*, users.* 
FROM requests
...
if($sApproved==="0")
{
	$statusIcon="<button class='btn btn-danger' onclick=window.location='php-update-special-status.php?ns=1&lid=$requestID&u=$cUID'><i class='fa fa-times'></i></button>";
}
if($sApproved==="1")
{
	$statusIcon="<button class='btn btn-primary' onclick=window.location='php-update-special-status.php?ns=0&lid=$requestID'><i class='fa fa-check'></i></button>";
}


$viewIcon= "<button class='btn btn-success' onclick=window.location='view-special-days-details.php?id=$requestID'><i class='fa fa-eye'></i></button>";
